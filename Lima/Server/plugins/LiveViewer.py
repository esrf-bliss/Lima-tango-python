...
class LiveViewer(PyTango.LatestDeviceImpl):
    ...
    def read_Image(self, attr):
        ...
        attr.set_value(
            self._flat_image, dim.getSize().getWidth(), dim.getSize().getHeight()
        )
...
class LiveViewerClass(PyTango.DeviceClass):
    ...
    cmd_list = {
        ...
        "ResetRoi": [[PyTango.DevVoid, ""], [PyTango.DevVoid, ""]],
    ...
    attr_list = {
        ...
        "Roi": [
            [PyTango.DevLong, PyTango.SPECTRUM, PyTango.READ_WRITE, 4],
            {
        ...
        "JpegImage": [
            [PyTango.DevEncoded, PyTango.SCALAR, PyTango.READ_WRITE],
            {
