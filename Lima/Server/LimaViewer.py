...
class LimaViewer(PyTango.LatestDeviceImpl):
    ...
    def read_Image_ccd(self, attr):
        ...
        if self.get_state() != PyTango.DevState.FAULT:
            ...
            self.attr_Image_ccd_read = numpy.frombuffer(data, dtype=numpyType).reshape(
                self.shape_ccd[:2]
            )
...
class LimaViewerClass(PyTango.DeviceClass):
    ...
    device_property_list = {
        "Dev_Ccd_name": [PyTango.DevString, "Nom device CCD", ["lima/limaccds/dev0"]]
    }
    ...
    attr_list = {
        "Exposure_time": [[PyTango.DevDouble, PyTango.SCALAR, PyTango.WRITE]],
        "Number_of_frames": [[PyTango.DevDouble, PyTango.SCALAR, PyTango.WRITE]],
        "Image_ccd": [
            [PyTango.DevUShort, PyTango.IMAGE, PyTango.READ, 4096, 4096],
            {"Polling period": "100"},
        ],
    }
